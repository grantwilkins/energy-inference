...
mean_energy_per_token_m1_pro = (
    df_m1_pro.groupby("Number of Output Tokens")["Energy per Token (J/tokens)"]
    .mean()
    .to_dict()
)
mean_energy_per_token_swing = (
    df_swing.groupby("Number of Output Tokens")["Energy per Token (J/tokens)"]
    .mean()
    .to_dict()
)

mean_throughput_m1_pro = (
    df_m1_pro.groupby("Number of Output Tokens")["Throughput (tokens/s)"]
    .mean()
    .to_dict()
)
mean_throughput_swing = (
    df_swing.groupby("Number of Output Tokens")["Throughput (tokens/s)"]
    .mean()
    .to_dict()
)

mean_runtime_m1_pro = (
    df_m1_pro.groupby("Number of Output Tokens")["Runtime (s)"].mean()
).to_dict()
mean_runtime_swing = (
    df_swing.groupby("Number of Output Tokens")["Runtime (s)"].mean()
).to_dict()
...
plt.savefig("heterogeneous-threshold-plot-output.pdf", bbox_inches="tight")
...
plt.savefig("heterogeneous-threshold-runtime-plot-output.pdf", bbox_inches="tight")
