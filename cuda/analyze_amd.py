...
ax1.set_title("Mean Power Draw (Cores 0-63)")
ax2.set_title("Mean Power Draw (Cores 64-127)")
ax1.set_xlabel("Core")
ax1.set_ylabel("Core")
ax2.set_xlabel("Core")
ax2.set_ylabel("Core")
plt.savefig("mean_power_usage_heatmap.pdf")
...
#     axs[idx].set_ylabel("Power Consumption (W)", fontsize=14)
...
# plt.tight_layout()
# plt.savefig("total_power_draw_batch_size.pdf")
