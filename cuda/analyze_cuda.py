...
token_count = 200
# Load the CSV data
df_1gpu = pd.read_csv("mistral7b-cuda-1.csv", sep=";")
df_1gpu["GPU Count"] = 1
df_2gpu = pd.read_csv("mistral7b-cuda-2.csv", sep=";")
df_2gpu["GPU Count"] = 2
df_4gpu = pd.read_csv("mistral7b-cuda-4.csv", sep=";")
df_4gpu["GPU Count"] = 4
df_8gpu = pd.read_csv("mistral7b-cuda-8.csv", sep=";")
df_8gpu["GPU Count"] = 8
...
plt.ylabel("Energy (J)")
plt.tight_layout()
plt.savefig("mistral7b-cuda-barchart.pdf")

df.to_csv("mistral7b-cuda.csv", sep=",")
